...
export { compileUserRegex, isLikelyCatastrophic } from './core/regex-safe.js';
export { renderString, renderValue, describeRow } from './core/template.js';
...
export { formatHtml } from './report/html.js';
export { buildTimeline } from './report/timeline.js';
...
// v0.7: structured-output + data-flow assertions
export { checkAnswerShape, checkFlowUsesResult } from './assert/matchers/structure.js';

// v0.8: cassette evolution + schema conversion + health checks
export { rebaseCassettes } from './cassette/rebase.js';
export type { RebaseResult, RebaseSummary, RebaseUpdate, RebaseOptions } from './cassette/rebase.js';
export { convertJsonSchema, renderShapeYaml } from './assert/schema.js';
export type { ShapeConversion } from './assert/schema.js';
export { diagnoseCassette, doctorExitCode } from './cassette/doctor.js';
export type { DoctorResult, DoctorFinding, DoctorLevel } from './cassette/doctor.js';

// commands (programmatic)
export { runTest, evaluateSuite } from './commands/test.js';
export { expandCase } from './suite/expand.js';
